  ...
  return (
    <>
        <div className="form-head mb-4 mb-sm-5 d-flex  flex-wrap align-items-center select-btn">
			<h2 className="font-w600 mb-0 me-auto">Market Capital</h2>
			<Dropdown>
				<Dropdown.Toggle variant="" className="form-control style-1 default-select me-3">{crrency1}</Dropdown.Toggle>
				<Dropdown.Menu>
			...
			<Link to={"#"} className="btn btn-outline-primary"><i className="las la-calendar scale5 me-2"></i>Filter Periode</Link>
		</div>
		<div className="row">
