	...
	return(
		<Fragment>
			<div className="form-head d-flex align-items-center flex-wrap mb-3">
				...
				<Link to={"#"} className="btn btn-outline-secondary ms-auto"><i className="las la-calendar scale5 me-2"></i>Filter Periode</Link>
			</div>
			<div className="row">
							...
							<table className="table display mb-4 dataTablesCard short-one card-table text-black dataTable no-footer" id="transaction_table"
								...
								<tbody>
									<tr role="row" className="odd">
										...
										<td>Marquezz</td>
										<td><div className="d-flex align-items-center"><img src={table1} alt="" className="rounded-circle me-2 width40 height40"/><span>Samuel</span></div></td>
									...
									<tr role="row" className="even">
										...
										<td>2/5/2020 06:24 AM</td>
										<td>Marquezz</td>
										<td><div className="d-flex align-items-center"><img src={table2} alt="" className="rounded-circle me-2 width40 height40"/><span>Cindy</span></div></td>
									...
									<tr role="row" className="odd">
										...
										<td>2/5/2020 06:24 AM</td>
										<td>Marquezz</td>
										<td><div className="d-flex align-items-center"><img src={table3} alt="" className="rounded-circle me-2 width40 height40"/><span>Marquezz</span></div></td>
									...
									<tr role="row" className="even">
										...
										<td>2/5/2020 06:24 AM</td>
										<td>Marquezz</td>
										<td><div className="d-flex align-items-center"><img src={table1} alt="" className="rounded-circle me-2 width40 height40" /> <span>David</span></div></td>
										<td className="wspace-no"> <CoinIcon3 /></td>
										<td><span className="text-black font-w700">+$5,553</span></td>
										<td><p className="mb-0">None</p></td>
										<td> <Link to="/transactions" className="btn-link  float-end">PENDING</Link></td>
									</tr>
									<tr role="row" className="odd">
										<td className="pr-0 sorting_1"><ArrowDown /></td>
										<td>#12415346563475</td>
										<td>2/5/2020 06:24 AM</td>
										<td>Thomas</td>
										<td><div className="d-flex align-items-center"><img src={table1} alt="" className="rounded-circle me-2 width40 height40"/><span>Cindy</span></div></td>
										<td className="wspace-no"><CoinIcon4 /></td>
										<td><span className="text-black font-w700">+$5,553</span></td>
										<td><p className="mb-0">Lorem ipsum dol</p></td>
										<td><Link to="/transactions" className="btn-link text-success float-end">COMPLETED</Link></td>
									...
									<tr role="row" className="even">
										...
										<td>2/5/2020 06:24 AM</td>
										<td>Marquezz</td>
										<td><div className="d-flex align-items-center"><img src={table2} alt="" className="rounded-circle me-2 width40 height40"/><span>Samuel</span></div></td>
										<td className="wspace-no"><CoinIcon2 /></td>
										<td><span className="text-black font-w700">-$12,768</span></td>
										<td><p className="mb-0 ">None</p></td>
										<td><Link to="/transactions" className="btn-link  float-end"> PENDING</Link></td>
									...
									<tr role="row" className="odd">
										...
										<td>2/5/2020 06:24 AM</td>
										<td>Marquezz</td>
										<td><div className="d-flex align-items-center"><img src={table3} alt="" className="rounded-circle me-2 width40 height40"/><span>Samuel</span></div></td>
										<td className="wspace-no"> <CoinIcon1 /></td>
										<td><span className="text-black font-w700">-$455</span></td>
										<td><p className="mb-0">Lorem ipsum dol</p></td>
										<td><Link to="/transactions" className="btn-link text-danger float-end">CANCELED</Link></td>
									...
									<tr role="row" className="odd">
										...
										<td>2/5/2020 06:24 AM</td>
										<td>Marquezz</td>
										<td><div className="d-flex align-items-center"><img src={table3} alt="" className="rounded-circle me-2 width40 height40"/><span>David</span></div></td>
										<td className="wspace-no"> <CoinIcon4 /></td>
										<td><span className="text-black font-w700">-$455</span></td>
										<td><p className="mb-0">Lorem ipsum dol</p></td>
										<td><Link to="/transactions" className="btn-link  float-end">PENDING</Link></td>
									...
									<tr role="row" className="odd">
										...
										<td>2/5/2020 06:24 AM</td>
										<td>Marquezz</td>
										<td><div className="d-flex align-items-center"><img src={table1} alt="" className="rounded-circle me-2 width40 height40"/><span>Lucyana</span></div></td>
										<td className="wspace-no"><CoinIcon4 /></td>
										<td><span className="text-black font-w700">+$5,553</span></td>
										<td><p className="mb-0">Lorem ipsum dol</p></td>
										<td><Link to="/transactions" className="btn-link text-success float-end"> COMPLETED</Link></td>
