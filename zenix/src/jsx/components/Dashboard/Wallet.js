	...
	return(
		<Fragment>
			<div className="form-head mb-sm-5 mb-3 d-flex align-items-center flex-wrap">
				<h2 className="font-w600 mb-0 me-auto mb-2 text-black">My Wallet</h2>
				<Link to={"#"} className="btn btn-outline-secondary me-3 mb-2"><i className="las la-calendar scale5 me-2"></i>Filter Periode</Link>
						...
						<div className="col-xl-12">
							<div className="d-block d-sm-flex mb-4">
								...
								<div className="d-flex mt-sm-0">
									<Link to={"#"} className="btn-link me-3 underline">Generate Number</Link>
												...
												<div className="col-sm-6">
													...
													<div>
														...
														<div className="btn-group theme-colors" data-toggle="buttons">
															...
															<label className="btn btn-warning btn-sm"><input type="radio" className="position-absolute invisible" name="options" id="option1" defaultChecked="" /><i className="las la-check-circle"></i></label>
								...
								<div className="card-header d-sm-flex d-block pb-0 border-0">
									...
									<Dropdown className="custom-dropdown d-block mt-3 mt-sm-0 mb-0">
										<Dropdown.Toggle variant="" className="btn btn-light btn-sm d-flex align-items-center svg-btn i-false" data-toggle="dropdown">
											<svg className="me-2" width="25" height="25" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
