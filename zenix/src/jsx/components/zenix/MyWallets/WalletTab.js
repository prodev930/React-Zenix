...
const PendingLink = () =>{
	return(
		<Link to={"#"} className="btn-link  float-end" >Pending</Link>
	)
}
const Downarrow = () =>{
	return(
					...
					<div className="card-header pb-2 d-block d-sm-flex flex-wrap border-0">
						...
						<div className="card-action card-tabs mb-3 style-1">
							<Nav as="ul" className="nav nav-tabs" role="tablist">
								<Nav.Item as="li" className="nav-item"><Nav.Link to={"#"} eventKey="Monthly">Monthly</Nav.Link></Nav.Item>
								<Nav.Item as="li" className="nav-item"><Nav.Link to={"#"} eventKey="Weekly">Weekly</Nav.Link></Nav.Item>
								<Nav.Item as="li" className="nav-item"><Nav.Link to={"#"} eventKey="Today">Today</Nav.Link></Nav.Item>
							</Nav>
						</div>
					</div>
