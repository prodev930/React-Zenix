				...
				<div className="tab-content tab-content-default tabcontent-border">
					<div className="tab-pane fade active show" id="home8" role="tabpanel">
						<div className="admin-settings">
							<h4 className="admin-title">Pick your style</h4>
					...
					<div className="dz-wrapper row">
						...
						<div className="col-xl-3 col-md-6 mb-4">
							<div className="overlay-bx rounded-lg dz-demo-bx">
								...
								<div className="overlay-layer">
								<Link to={"#"}  onClick={() => setDemoTheme(7,'ltr')} data-theme="7" className="btn dz_theme_demo btn-secondary btn-sm me-2">Default</Link>
						...
						<div className="col-xl-3 col-md-6 mb-4">
							<div className="overlay-bx rounded-lg dz-demo-bx">
								...
								<div className="overlay-layer">
								<Link to={"#"}  onClick={() => setDemoTheme(8,'ltr')} data-theme="8" className="btn dz_theme_demo btn-secondary btn-sm me-2">Default</Link>
